...
const navItems: NavItem[] = [
  ...
  {
    label: "Guides & Forms", href: "/operations/documents",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Leadership Program Submissions", href: "/admin/submissions", roles: ["global_admin"] },
      { label: "Moderation", href: "/admin/moderation", roles: ["global_admin"] },
      { label: "Send Announcement", href: "/admin/broadcast", roles: ["global_admin"] },
      { label: "Create Groups in Bulk", href: "/admin/groups", roles: ["global_admin"] },
